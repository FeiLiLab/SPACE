...
cluster_stats <- as.data.frame(obj_BLCA@meta.data %>%
                                 ...
                                 summarise(
                                   ...
                                   n_cells = n()))
cluster_stats_retained<-cluster_stats[(cluster_stats$n_cells>2&cluster_stats$mean_nFeature>100),] # The optimal mean_nFeature threshold can be changed for different datasets.
...
obj_BLCA <- RenameIdents(obj_BLCA,'XXX' = 'Malignant/Epithelial','XXX' = 'Fibroblast','XXX' = 'Myofibroblast','XXX' = 'Endothelial','XXX' = 'Pericyte',
